 ...
 * {@link RocksDB#getApproximateSizes(ColumnFamilyHandle,java.util.List<Range>,SizeApproximationOptions)}.
 */
public class SizeApproximationOptions extends RocksObject {
   ...
   */
  public SizeApproximationOptions setIncludeMemtables(
      final boolean includeMemtables) {
   ...
   * @return this {@code SizeApproximationOptions} object
   */
  public SizeApproximationOptions setIncludeFiles(
   ...
   * using {@link RocksDB#getApproximateSizes(ColumnFamilyHandle,java.util.List<Range>,SizeApproximationOptions)},
   ...
   * @return this {@code SizeApproximationOptions} object
   */
  public SizeApproximationOptions setFilesSizeErrorMargin(
      final double filesSizeErrorMargin) {
    assert(isOwningHandle());
  ...
  private native void setIncludeMemtables(final long handle,
      final boolean includeMemtables);
  private native boolean includeMemtables(final long handle);
  private native void setIncludeFiles(final long handle,
      final boolean includeFiles);
  private native boolean includeFiles(final long handle);
  private native void setFilesSizeErrorMargin(final long handle,
      final double filesSizeErrorMargin);
